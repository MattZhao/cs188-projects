...
class Actions:
    ...
    def getPossibleActions(config, walls, redWalls, blueWalls):
        possible = []
        x, y = config.pos
        ...
        for dir, vec in Actions._directionsAsList:
            ...
            next_y = y_int + dy
            next_x = x_int + dx
            if not walls[next_x][next_y] and not redWalls[next_x][next_y] and not blueWalls[next_x][next_y]:
                possible.append(dir)
...
class GameStateData:
    ...
    def __init__( self, prevState = None ):
        ...
        if prevState != None:
            ...
            self.observedPositions = prevState.observedPositions
    ...
    def initialize( self, layout, numGhostAgents ):
        ...
        self.score = 0
        self.scoreChange = 0
        self.observedPositions = Grid(self.layout.width, self.layout.height, False)
